                        ...
                        <div class="row g-0">
                            <div class="col-md-6">
                                <div id="imageContainer" style="width: 400px; height: 400px; cursor: pointer; display: flex; justify-content: center; align-items: center;">
                                    <input type="file" name="staffImage" id="fileInput" accept="image/*" style="display: none;" onchange="displayImage(event)">
                                    <img class="img-account-profile rounded-circle mb-2"
                                         src="{{ asset('assets/img/demo/user-placeholder.svg') }}"
                                         alt=""
                                         id="selectedImage"
                                    >
                                    {{-- <img id="selectedImage" style="display: none; max-width: 100%; max-height: 100%; object-fit: contain;" /> --}}
                                </div>
                            </div>                            
                            <div class="col-md-6">
                                <div class="card-body">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input
                                            ...
                                            {{-- onfocus="this.style.borderBottomColor = 'blue';"
